...
public class NotificationDatabase2 {
    private static final String FILE_PATH = "NotificationsForRequests.json";

    // Save notifications to a JSON file with custom structure
    public static void saveNotificationsToFile(List<NotificationForRequest> notifications) {
        try {
    ...
    public static List<NotificationForRequest> loadNotificationsFromFile() {
        try {
            ...
            List<NotificationForRequest> notifications = objectMapper.readValue(file,
